...
# 安装基本软件
apt install apt-transport-https ca-certificates sudo man man-db bash-completion network-manager wpasupplicant openssh-server initramfs-tools locales perl systemd-timesyncd --no-install-recommends -y
