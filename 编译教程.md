...
# 下载config
cd ~/workspace/linux
wegt https://raw.githubusercontent.com/lyrnya/linuxformido/main/.configdae
...
# 安装基本软件
apt install man man-db bash-completion network-manager wpasupplicant [chrony] openssh-server initramfs-tools locales perl systemd-timesyncd --no-install-recommends -y
...
mkbootimg --base 0x80000000 \
        ...
        --cmdline "console=tty0 root=UUID=fcf40267-74a1-42b4-909b-e6785814bac7 rw loglevel=3"\
